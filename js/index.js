...
function createProjectBoard() // can replace later with a more clean implementation, such as reading from a file
{
  return createEle(
    ...
    createEle(projectSlider, {img: "playingcards.png", link: "https://github.com/ye-spencer/24-Game-Solver", title: "24 Game Solver", skills: "Python, Selenium, OpenCV", desc: "This project was originally designed to determine what percentage of hands were solvable in the card game '24'. It has since progressed into a solver for the game 4nums.com"}),
