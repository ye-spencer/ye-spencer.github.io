...
const blogTitles = ["How To Play 24"]
const blogTags = ["Games"]
...
function createProjectBoard() // can replace later with a more clean implementation, such as reading from a file
{
  return createEle(
    ...
    createEle(projectSlider, {img: "playingcards.png", link: "https://github.com/ye-spencer/24-Game-Solver", title: "24 Game Solver & Bot", skills: "Python, Selenium, OpenCV, PyTesseract", desc: "Originally designed to determine what percentage of hands were solvable in the card game '24', this project has since progressed into a bot to play 24 online on the website 4nums."}),
    createEle(projectSlider, {img: "windowscomputer.png", link: "https://github.com/ye-spencer/Windows-Motivational-Backgrounds", title: "Windows Background Creator", skills: "C++, Python, Pillow", desc: "Creates and automatically updates a Windows device's background with motivational quotes, lessons, and more."}),
    createEle(projectSlider, {img: "california.png", link: "https://github.com/ye-spencer/California-HS-Data-Project", title: "California High School Performance (Developing)", skills: "SQL, R", desc: "This project aims to determine which high schools in California are the most successful, and what factors lead to those success"}),
